...
static const dbtool_column_v1 TEST_COLUMNS[] = {
    {sizeof(dbtool_column_v1), DBTOOL_MODEL_ABI_VERSION, 0u, 0u,
     DBTOOL_SCALAR_INT64, DBTOOL_STORAGE_INTEGER64, "signed_value", "signed_value"},
    {sizeof(dbtool_column_v1), DBTOOL_MODEL_ABI_VERSION, 1u, 0u,
     DBTOOL_SCALAR_UINT64, DBTOOL_STORAGE_UINT64_DECIMAL, "unsigned_value", "unsigned_value"},
    {sizeof(dbtool_column_v1), DBTOOL_MODEL_ABI_VERSION, 2u, 0u,
     DBTOOL_SCALAR_DOUBLE, DBTOOL_STORAGE_FLOAT64, "ratio", "ratio"},
    ...
    {sizeof(dbtool_column_v1), DBTOOL_MODEL_ABI_VERSION, 8u,
     DBTOOL_COLUMN_GENERATED, DBTOOL_SCALAR_INT64,
     DBTOOL_STORAGE_INTEGER64, "generated_id",
     "generated_id"},
    {sizeof(dbtool_column_v1), DBTOOL_MODEL_ABI_VERSION, 9u,
     DBTOOL_COLUMN_HAS_DEFAULT, DBTOOL_SCALAR_TEXT, DBTOOL_STORAGE_TEXT,
     "default_name",
     "default_name"}};
