...
inline int connect_expand_dbname = 0;
inline std::vector<std::string> connect_keywords;
inline std::vector<std::string> connect_values;
...
inline void reset_script_state()
{
    ...
    connect_expand_dbname = 0;
    connect_keywords.clear();
    connect_values.clear();
    last_sql.clear();
