 ...
 */
REDIS_API redis_pool_t *redis_pool_create(const redis_pool_config_t *config);
 ...
 */
REDIS_API int redis_pool_start(redis_pool_t *pool);
 ...
 * @param pool Pool instance
 */
REDIS_API void redis_pool_stop(redis_pool_t *pool);
 ...
 * @param pool Pool instance
 */
REDIS_API void redis_pool_destroy(redis_pool_t *pool);
 ...
 * @return 0 on success, -1 on failure
 */
REDIS_API int redis_pool_command(redis_pool_t *pool, redis_command_cb_t callback,
                       void *user_data, const char *format, ...);

/**
 * Execute command with argv
 */
REDIS_API int redis_pool_commandv(redis_pool_t *pool, int argc, const char **argv,
 ...
 */
REDIS_API int redis_pool_commandv_result(redis_pool_t *pool, int read_only,
 ...
 * @return 0 on success
 */
REDIS_API int redis_pool_read_command(redis_pool_t *pool, redis_command_cb_t callback,
                            void *user_data, const char *format, ...);
 ...
 */
REDIS_API redis_pool_conn_t *redis_pool_acquire(redis_pool_t *pool, int read_only);
 ...
 */
REDIS_API void redis_pool_release(redis_pool_t *pool, redis_pool_conn_t *conn);
 ...
 */
REDIS_API redis_client_t *redis_pool_conn_client(redis_pool_conn_t *conn);
 ...
 */
REDIS_API redis_pipeline_t *redis_pool_pipeline_create(redis_pool_t *pool);
 ...
 * @return 0 on success
 */
REDIS_API int redis_pipeline_add(redis_pipeline_t *pipeline, redis_command_cb_t callback,
                       void *user_data, const char *format, ...);
 ...
 * @return 0 on success
 */
REDIS_API int redis_pipeline_addv(redis_pipeline_t *pipeline, redis_command_cb_t callback,
 ...
 * @param pipeline Pipeline handle
 */
REDIS_API void redis_pipeline_clear(redis_pipeline_t *pipeline);
 ...
 * @return 0 on success
 */
REDIS_API int redis_pipeline_execute(redis_pipeline_t *pipeline);
 ...
 * @return 0 on success
 */
REDIS_API int redis_pipeline_sync(redis_pipeline_t *pipeline);
 ...
 * @return 0 on success
 */
REDIS_API int redis_pipeline_execute_collect(redis_pipeline_t *pipeline,
                                             redis_reply_t ***replies,
                                             size_t *reply_count);

/** Execute a pipeline without collapsing transport uncertainty or errors. */
REDIS_API int redis_pipeline_execute_result(redis_pipeline_t *pipeline,
                                             redis_pipeline_result_t *out);

/** Release replies owned by a pipeline result and reset it to NOT_SENT. */
REDIS_API void redis_pipeline_result_clear(redis_pipeline_result_t *result);
 ...
 * @return 0 on success
 */
REDIS_API int redis_pipeline_sync_and_return_all(redis_pipeline_t *pipeline,
                                                 redis_reply_t ***replies,
                                                 size_t *reply_count);
 ...
 */
REDIS_API void redis_pipeline_replies_free(redis_reply_t **replies, size_t reply_count);
 ...
 * @param pipeline Pipeline handle
 */
REDIS_API void redis_pipeline_destroy(redis_pipeline_t *pipeline);
...
/* String commands */
REDIS_API int redis_pool_set(redis_pool_t *pool, const char *key, const char *value,
                   redis_command_cb_t callback, void *user_data);
REDIS_API int redis_pool_get(redis_pool_t *pool, const char *key,
                   redis_command_cb_t callback, void *user_data);
REDIS_API int redis_pool_del(redis_pool_t *pool, int key_count, const char **keys,
                   redis_command_cb_t callback, void *user_data);
REDIS_API int redis_pool_expire(redis_pool_t *pool, const char *key, int seconds,
                      redis_command_cb_t callback, void *user_data);

/* Hash commands */
REDIS_API int redis_pool_hset(redis_pool_t *pool, const char *key, const char *field,
                    const char *value, redis_command_cb_t callback, void *user_data);
REDIS_API int redis_pool_hget(redis_pool_t *pool, const char *key, const char *field,
                    redis_command_cb_t callback, void *user_data);

/* Stream commands */
REDIS_API int redis_pool_xadd(redis_pool_t *pool, const char *key, size_t maxlen,
                    size_t field_count, const char **fields,
                    const char **values, const size_t *value_lens,
                    redis_command_cb_t callback, void *user_data);

REDIS_API int redis_pool_xreadgroup(redis_pool_t *pool, const char *group,
...
REDIS_API void redis_pool_test_set_socket_hooks(redis_pool_test_send_hook_t send_hook,
                                                redis_pool_test_recv_hook_t recv_hook,
                                                redis_pool_test_free_recv_hook_t free_recv_hook);
REDIS_API int redis_pool_test_execute_batch(redis_client_t *client,
                                            const char **commands,
                                            size_t command_count);
REDIS_API int redis_pool_test_execute_batch_collect(redis_client_t *client,
                                                    const char **commands,
                                                    size_t command_count,
                                                    redis_reply_t ***replies,
                                                    size_t *reply_count);
REDIS_API int redis_pool_test_execute_pipeline_collect(redis_pipeline_t *pipeline,
                                                       redis_client_t *client,
                                                       redis_reply_t ***replies,
                                                       size_t *reply_count);
REDIS_API int redis_pool_test_execute_pipeline_result(redis_pipeline_t *pipeline,
                                                      redis_client_t *client,
                                                      redis_pipeline_result_t *out);
#endif
 ...
 */
REDIS_API void redis_pool_get_stats(redis_pool_t *pool, redis_pool_stats_t *stats);
 ...
 * @param pool Pool instance
 */
REDIS_API void redis_pool_reset_stats(redis_pool_t *pool);
 ...
 */
REDIS_API int redis_pool_is_healthy(redis_pool_t *pool);
 ...
 */
REDIS_API size_t redis_pool_available(redis_pool_t *pool);
